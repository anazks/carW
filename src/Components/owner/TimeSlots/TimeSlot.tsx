...
import { Plus, Trash2, Save, Clock, Minus, Users } from "lucide-react"
...
export default function OwnerTimeSlots() {
  ...
  const updateTimeSlot = (id: number, field: keyof TimeSlot, value: string | number | boolean) => {
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage your available time slots and capacity for bookings</p>
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-blue-800">Available Slots per Time</p>
                <p className="text-sm text-blue-600">
                  Set how many simultaneous bookings can be made for each time slot. Users will see the remaining
          ...
          {timeSlots.length === 0 && (
            <div className="border-2 border-dashed rounded-xl p-10 text-center">
              ...
              <p className="text-sm text-gray-400">Add time slots to define when customers can book your services</p>
            </div>
          )}
              ...
              {timeSlots.map((slot) => (
                <div
                  ...
                  className={`border-2 rounded-xl p-5 transition-all ${
                    slot.isActive ? "bg-gray-50 border-gray-200" : "bg-gray-100 border-gray-300 opacity-60"
                  }`}
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                    ...
                    {/* Available Slots */}
                    <div>
                      <label className="text-sm font-medium text-gray-700 block mb-1">Available Slots</label>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              updateTimeSlot(
                                slot.id,
                                "availableSlots",
                                val === "" ? 1 : Math.max(1, Math.min(99, Number.parseInt(val))),
                              )
                            }}
