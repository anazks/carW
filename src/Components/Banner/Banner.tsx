                ...
                >
                  <div
                    className={`p-2 rounded-lg ${
                      selectedVehicle === type ? 'bg-blue-100' : 'bg-white'
                    }`}
                  >
                    {icon}
                  </div>
...
function CarImage({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 400 250" fill="none">
      ...
      {/* Front Wheel */}
      <circle cx="120" cy="182" r="22" fill="#1e3a8a" />
      <circle cx="120" cy="182" r="12" fill="#e0f2fe" />
      
      {/* Back Wheel */}
      <circle cx="280" cy="182" r="22" fill="#1e3a8a" />
      <circle cx="280" cy="182" r="12" fill="#e0f2fe" />
...
function BikeImage({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 400 250" fill="none">
      ...
      {/* Handlebar */}
      <path d="M 180 105 L 190 95 L 200 105" stroke="#1e3a8a" strokeWidth="4" fill="none" />
      
      {/* Front Wheel */}
      <circle cx="130" cy="165" r="25" fill="#1e3a8a" />
      <circle cx="130" cy="165" r="15" fill="#e0f2fe" />
      
      {/* Back Wheel */}
      <circle cx="230" cy="165" r="25" fill="#1e3a8a" />
      <circle cx="230" cy="165" r="15" fill="#e0f2fe" />
...
function HeavyImage({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 400 250" fill="none">
      ...
      {/* Truck Bed */}
      <rect x="230" y="95" width="150" height="60" rx="5" fill="#1e40af" />
      <rect x="240" y="105" width="130" height="40" rx="3" fill="#60a5fa" />
      ...
      {/* Front Wheel */}
      <circle cx="120" cy="155" r="20" fill="#1e3a8a" />
      <circle cx="120" cy="155" r="10" fill="#e0f2fe" />
      
      {/* Middle Wheel */}
      <circle cx="180" cy="155" r="20" fill="#1e3a8a" />
      <circle cx="180" cy="155" r="10" fill="#e0f2fe" />
      
      {/* Back Wheel */}
      <circle cx="320" cy="155" r="20" fill="#1e3a8a" />
      <circle cx="320" cy="155" r="10" fill="#e0f2fe" />
